		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "balance sheet and dupont analysis",
									"targetURL": "#z03sefiorifi01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z03sefiorifi01-display": {
								"semanticObject": "z03sefiorifi01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z03sefiorifi01",
									"url": sap.ui.require.toUrl("z03sefiorifi01")
								}
							}
						}
					}
