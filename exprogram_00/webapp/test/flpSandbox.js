		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Read (00)",
									"targetURL": "#examexprogram00-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram00-display": {
								"semanticObject": "examexprogram00",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram00",
									"url": sap.ui.require.toUrl("exam/exprogram00")
								}
							}
						}
					}
