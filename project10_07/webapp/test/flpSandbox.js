		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#odataproject1007-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataproject1007-display": {
								"semanticObject": "odataproject1007",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.project1007",
									"url": sap.ui.require.toUrl("odata/project1007")
								}
							}
						}
					}
