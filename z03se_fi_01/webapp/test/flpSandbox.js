					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "balance sheet fiori",
									"targetURL": "#z03sefi01-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"z03sefi01-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z03sefi01",
									"url": sap.ui.require.toUrl("z03sefi01")
								}
							}
						}
					}
