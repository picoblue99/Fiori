		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX400 문제",
									"targetURL": "#ux400solving-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ux400solving-display": {
								"semanticObject": "ux400solving",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux400solving",
									"url": sap.ui.require.toUrl("ux400solving")
								}
							}
						}
					}
