					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monthly sales/purchase analysis",
									"targetURL": "#z03sefi02-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"z03sefi02-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z03sefi02",
									"url": sap.ui.require.toUrl("z03sefi02")
								}
							}
						}
					}
